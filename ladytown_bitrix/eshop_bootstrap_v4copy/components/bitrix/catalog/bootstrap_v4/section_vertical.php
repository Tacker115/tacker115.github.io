...
<div class="row mb-4 bx-<?=$arParams["TEMPLATE_THEME"]?>">
	<? if ($isFilter || $isSidebar): ?>
		<div class="col-lg-3 col-md-4<?=(isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' d-none d-sm-block' : '')?>">
			<?
			//region Filter
			if ($isFilter): ?>
	...
	<div class="pb-4 <?=(($isFilter || $isSidebar) ? "col-lg-9 col-md-8" : "col")?>">
		<?
