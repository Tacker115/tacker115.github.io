...
{
	?>
	<a class="icons-header-link header-icon2" id="session_basket" href="<?=$arParams['PATH_TO_BASKET']?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/basket.svg" alt="">
	<?
}
...
if (!$compositeStub)
{
	...
	{
		?>
		<span class="basket-num"><? echo $arResult['NUM_PRODUCTS']; ?></span></a> <?
